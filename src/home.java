...
public class home extends javax.swing.JFrame {
    ...
    public home() {
        ...
        jLabel11.setVisible(false);
            ...
            JOptionPane.showMessageDialog(null, "Error loading home screen: " + e.getMessage());
        }
    }
    ...
    private void initComponents() {
        ...
        jButton1.setToolTipText("View Menu.");
        jButton1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jButton1MouseClicked(evt);
            }
        });
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(17, 17, -1, -1));

        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/new buyer.png"))); // NOI18N
        jButton2.setToolTipText("Add new buyers.");
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 20, -1, -1));

        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Update buyer.png"))); // NOI18N
        jButton3.setToolTipText("Update existing buyers.");
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 20, -1, -1));

        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/buyer Details.png"))); // NOI18N
        jButton4.setToolTipText("View buyer details.");
        ...
        jButton5.setToolTipText("Delete an existing buyer.");
        ...
        jButton6.setToolTipText("Add new product.");
        ...
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 20, -1, -1));

        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/update product.png"))); // NOI18N
        jButton7.setToolTipText("Update existing product.");
        ...
        getContentPane().add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 20, -1, -1));

        jButton8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/details product.png"))); // NOI18N
        jButton8.setToolTipText("View product details.");
        ...
        getContentPane().add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 20, -1, -1));

        jButton9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/delete product.png"))); // NOI18N
        jButton9.setToolTipText("Delete existing products.");
        ...
        getContentPane().add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 20, -1, -1));

        jButton10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/billing.png"))); // NOI18N
        jButton10.setToolTipText("Generate your bill.");
        ...
        getContentPane().add(jButton10, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 20, -1, -1));

        jButton11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/logout.png"))); // NOI18N
        jButton11.setToolTipText("LogOut your Account");
        ...
        getContentPane().add(jButton11, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 20, -1, -1));

        jButton12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Close.png"))); // NOI18N
        jButton12.setToolTipText("Close Billing App");
        jButton12.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton12ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton12, new org.netbeans.lib.awtextra.AbsoluteConstraints(1100, 20, -1, -1));
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 90, -1, -1));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel8.setText("Delete Product");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 90, -1, -1));
        ...
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(1020, 90, -1, -1));
        ...
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(-40, 0, 1370, 770));
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        // FIRST BUTTON (EVENT , MOUSE CLICK)
        if( z== 0){
            try{
                Thread.sleep(250);
    ...
    private void jButton2ComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jButton2ComponentShown
        // NEW BUYER BUTTON (EVENT , COMPONENT SHOWN)
        try{
                Thread.sleep(250);
    ...
    private void jButton3ComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jButton3ComponentShown
        // UPDATE BUYER BUTTON (EVENT , COMPONENT SHOWN)
        try{
                Thread.sleep(250);
    ...
    private void jButton4ComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jButton4ComponentShown
        // BUYER DETAILS BUTTON (EVENT , COMPONENT SHOWN)
        try{
                Thread.sleep(250);
    ...
    private void jButton5ComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jButton5ComponentShown
        // DELETE BUYER BUTTON (EVENT , COMPONENT SHOWN)
        try{
                Thread.sleep(250);
    ...
    private void jButton6ComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jButton6ComponentShown
        // NEW PRODUCT BUTTON (EVENT , COMPONENT SHOWN)
        try{
                Thread.sleep(250);
    ...
    private void jButton7ComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jButton7ComponentShown
        // UPDATE PRODUCT BUTTON (EVENT , COMPONENT SHOWN)
        try{
                Thread.sleep(250);
    ...
    private void jButton8ComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jButton8ComponentShown
        // PRODUCT DETAILS BUTTON (EVENT , COMPONENT SHOWN)
        try{
                Thread.sleep(250);
    ...
    private void jButton9ComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jButton9ComponentShown
        // DELETE PRODUCT BUTTON (EVENT , COMPONENT SHOWN)
        try{
                Thread.sleep(250);
    ...
    private void jButton10ComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jButton10ComponentShown
        // BILLING BUTTON (EVENT , COMPONENT SHOWN)
        try{
                Thread.sleep(250);
    ...
    private void jButton11ComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jButton11ComponentShown
        // LOGOUT BUTTON (EVENT , COMPONENT SHOWN)
        try{
                Thread.sleep(250);
                jButton12.setVisible(true);
                jLabel11.setVisible(true);
                z=1; // RETRIVES THE MENU BAR
            }
            catch(Exception e)
            {}
